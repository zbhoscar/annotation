function Gettimestep(DataRoot)
path = DataRoot;
path_laser = DataRoot;
lightpose = fopen([path,'lightposelog.txt'],'r');
txtnumber = fopen([path,'txtnumber.txt'],'w+');
simpleImgLog = fopen([path,'simpleImgLog.txt'],'w+');
timefile = fopen([path_laser,'TimeStamp.txt'],'r');
